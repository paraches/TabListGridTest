...
package com.paraches.android.tablistgridtest.listviewdragginganimation;
...
public class DynamicListView extends ListView {
            ...
            observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                public boolean onPreDraw() {
                    ...
                    if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                        switchViewAnimation(switchView, delta);
                    }
    ...
    private void switchViewAnimation(View switchView, int delta) {
    ...
    @TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH)
    private void touchEndAnimation(final View mobileView) {
